...
export const DotFlow = ({ items }: DotFlowProps) => {
    ...
    return (
        <div className="flex items-center gap-2.5 rounded-lg bg-black px-3 py-2">
            <DotLoader
                ...
                dotClassName="bg-white/15 [&.active]:bg-white size-[3px]"
            />
            <div ref={containerRef} className="relative overflow-hidden">
                <div ref={textRef} className="inline-block text-xs font-medium whitespace-nowrap text-white">
