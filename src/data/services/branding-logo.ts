...
export const brandingLogo: ServicePage = {
  ...
  blocks: [
    ...
    },
    {
      ...
      eyebrow: "Gratis brand-tjek",
      heading: "Genkender folk dit brand — eller forveksler de det med alle andres?",
      body: "Mange virksomheder har et logo. Færre har et brand. Forskellen er konsistens, strategi og en identitet der faktisk differentierer.\n\nVi kigger på dit brand med friske øjne og giver dig en ærlig vurdering — helt gratis.",
      cta: { label: "Book et gratis brand-tjek", href: "/kontakt" },
    },
    {
      type: "techChecklist",
      stickyGroup: "brandStack",
